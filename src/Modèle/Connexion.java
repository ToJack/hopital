...
public class Connexion {
    ...
    public Connexion(String nameDatabase, String loginDatabase, String passwordDatabase) throws SQLException, ClassNotFoundException {
        ...
        if(stmt!=null){
            System.out.println("Stmt reussie ");
        }
    }
    ...
    public Connexion(String usernameECE, String passwordECE, String loginDatabase, String passwordDatabase) throws SQLException, ClassNotFoundException {
        ...
        if (ssh.connect()) {
            ...
            String urlDatabase = "jdbc:mysql://127.0.0.1:8889/" + usernameECE;
    ...
    /**
     * Méthode de test d'affichage simple
     * 
     * public ArrayList test(String requete) throws SQLException {
        rset = stmt.executeQuery(requete);
        rsetMeta = rset.getMetaData();
        int nombreColonne = rsetMeta.getColumnCount();
        ArrayList<String> liste;
        liste = new ArrayList<String>();
        while (rset.next()) {
            String champs;
